...
class DepartmentAdmin extends Component {
  constructor(props) {
    super(props)
    this.state = {
      departments: [],
  ...
  fetchAPI = async () => {
    return await axios
      .get('/admin/departments/?no_pagination=true', {
        headers: {
  ...
  handleInsertSubmit = async (event) => {
    ...
    await axios
      .post('/admin/departments/', newItem, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${TOKEN}`,
        },
  ...
  handleEditSubmit = async (event) => {
    ...
    await axios
      .put('/admin/departments/' + this.state.id + '/', newUpdate, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${TOKEN}`,
        },
  ...
  handleDelete = (event) => {
    ...
    axios
      .delete('/admin/departments/' + this.state.id + '/', {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${TOKEN}`,
        },
  ...
  handleSearch = async (event) => {
    ...
    const REGISTER_URL = '/admin/departments/?no_pagination=true&search=' + value
    ...
    return (
      <>
        ...
        <CRow>
          <CCol md={4}>
            <Input.Search
              placeholder="Tìm kiếm tên và mã bộ phận"
